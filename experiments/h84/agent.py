...
HYPOTHESIS_ID: str = os.environ.get("HYPOTHESIS_ID", "h84")
HYPOTHESIS_LABEL: str = "Coverage-Aware Claim Verdict Aggregation"
HYPOTHESIS_MODE: str = "coverage_claim_aggregation"
