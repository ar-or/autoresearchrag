...
HYPOTHESIS_ID: str = os.environ.get("HYPOTHESIS_ID", "h73")
HYPOTHESIS_LABEL: str = "Known-Unknown Query Decomposition Checks"
HYPOTHESIS_MODE: str = "known_unknown_checks"
