...
HYPOTHESIS_ID: str = os.environ.get("HYPOTHESIS_ID", "h69")
HYPOTHESIS_LABEL: str = "AlignRAG Evidence-Grounded Critique Loop"
HYPOTHESIS_MODE: str = "alignrag_critique_loop"
